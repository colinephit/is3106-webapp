...
exports.searchIngredients = async (req, res) => {
  try {
    ...
    const ingredients = await Ingredient.find({ ingredientName: regex }).sort({
      ingredientName: 1,
...
exports.editIngredient = async (req, res) => {
  ...
  try {
    ...
    console.log("ingredient name is", ingredientName);
    ...
    // In your editIngredient function:
    ...
    console.log("Before saving, existingIngredient:", existingIngredient);
    ...
    console.log("After saving, updatedIngredient:", updatedIngredient);
