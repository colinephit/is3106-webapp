...
const Index = ({ mainTitle, tagline, type, data, onFilterChange, count }) => {
    ...
    const { data: ing } = useGetIngredientsQuery(currentIngredient, {
    ...
    const handlePage = async (pageNum) => {
        try {
            setFilter((prev) => ({
                ...prev,
                currentPage: pageNum,
                skip: (Number(pageNum) - 1) * prev.limit,
            }));
        } catch (error) {
                        ...
                        <AccordionDetails className="text-center">
                            ...
                            <div>
                                ...
                                <Slider
                                    ...
                                    value={[
                                        filter.difficultyLevel.min,
                                        filter.difficultyLevel.max,
                                    ]}
                                    onChange={(e, newValue) =>
                                        handleRangeChange(
                                            "difficultyLevel",
