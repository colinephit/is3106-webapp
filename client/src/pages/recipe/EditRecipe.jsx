      ...
      setFormDetails({
        ...
        ingredients:
          data.ingredients.map((ing) => ({
            ...
            ingredientName:
              ing.ingredient?.ingredientName || ing.ingredientName,
    ...
    <section className="box flex flex-col gap-6">
      ...
      {rest.isLoading ? (
        ...
        >
          ...
          {/* Upload recipe image */}
          <div className="basis-1/3 rounded-xl shadow-md hover:shadow-primary hover:shadow flex justify-center items-center w-full p-8 height-fit">
            <label
              htmlFor="image"
